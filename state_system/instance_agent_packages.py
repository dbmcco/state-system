        ...
        routes.append(
            {
                ...
                "source_order": [
                    ...
                    "connector.personal.agent_memory.samantha",
                    "connector.personal.agent_memory.owner",
                    "connector.personal.msgvault",
                ...
                "tool_refs": [
                    ...
                    "tool.agent_memory.retrieve_turns",
                    "tool.agent_runtime.msgvault.search",
                    "tool.agent_runtime.workboard.read",
                ...
                "tool_action_refs": [
                    ...
                    "tool_action.agent_workboard.read",
                ...
                "required_actions": [
                    ...
                    "Use agent runtime memory Samantha conversation summaries, facets, and recent turns for Sam continuity context, and use example owner facets as separate owner context with tenant labels preserved.",
        ...
        routes.append(
            {
                ...
                "required_actions": [
                    ...
                    "Use agent runtime memory Samantha facets and owner facets as separately labeled context without promoting private facets or raw turns to relationship facts.",
        ...
        routes.append(
            {
                ...
                "optional_tools": ["tool.agent_runtime.msgvault.search", "tool.linear.search"],
