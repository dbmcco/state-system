...
- Paia OS has a newer implementation under
  `/Users/braydon/projects/experiments/paia-os/src/paia/integrations/spotify`
  with `AsyncSpotifyClient`, OAuth helpers, `SpotifyAdapter`, and
  `SpotifySyncService`.
- Paia OS also has an hourly Spotify history worker at
  `/Users/braydon/projects/experiments/paia-os/src/paia/workers/spotify_sync.py`.
- Paia OS migration support exists at
  `/Users/braydon/projects/experiments/paia-os/scripts/migrate_music.py`.
