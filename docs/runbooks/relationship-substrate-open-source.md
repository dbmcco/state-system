...
| No Braydon-specific defaults, local absolute paths, private emails, or provider env in OSS surface | upstream config and docs | required, audit on each release |
